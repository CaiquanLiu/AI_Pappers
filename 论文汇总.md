...
| NULL  | 《推荐系统调研报告及综述》 |推荐 |
| NULL  | 《Deep Neural Networks for YouTube Recommendations》 |推荐 |
| NULL  | 《Deep Crossing: Web-Scale Modeling without Manually Crafted Combinatorial Features》 |推荐 |
| NULL  | 《Deep & Cross Network for Ad Click Predictions》 |推荐 |
| NULL  | 《MOBIUS: Towards the Next Generation of Query-Ad Matching in Baidu’s Sponsored Search》 |推荐 |
| NULL  | 《Sampling-Bias-Corrected Neural Modeling for Large Corpus Item Recommendations 》 |推荐 |
| NULL  | 《bipartite graph neural networks for efficient node representation learning》 |推荐 |
| NULL  | 《Wide & Deep Learning for Recommender Systems》 |推荐 |
| NULL  | 《SESSION-BASED RECOMMENDATIONS WITH RECURRENT NEURAL NETWORKS》 |推荐 |
| NULL  | 《Semantic search on text and knowledge bases》 |搜索 |
| NULL  | 《A Deep Generative Approach to Search Extrapolation and Recommendation》 |搜索 |
| NULL  | 《A User-Centered Concept Mining System for Query and Document Understanding at Tencent》 |标签体系&标签扩展&兴趣标签&概念标签 |
| NULL  | 《GIANT: Scalable Creation of a Web-scale Ontology》 |标签体系&标签扩展&兴趣标签&概念标签 |
| NULL  | 《Meta-Learning for Qery Conceptualization at Web Scale》 |标签体系&标签扩展&兴趣标签&概念标签 |
| NULL  | 《AliCoCo: Alibaba E-commerce Cognitive Concept Net》 |标签体系&标签扩展&兴趣标签&概念标签 |
| NULL  | 《Octet: Online Catalog Taxonomy Enrichment with Self-Supervision》 |标签体系&标签扩展&兴趣标签&概念标签 |
...
| NULL  | 《Microblog Hashtag Generation via Encoding Conversation Contexts》 |标签生成 |
| NULL  | 《Cognitive Representation Learning of Self-Media Online Article Quality》 |文本审核&质量 |
| NULL  | 《Spam Review Detection with Graph Convolutional Networks》 |文本审核&质量 |
| NULL  | 《Abusive Language Detection with Graph Convolutional Networks》 |文本审核&质量 |
| NULL  | 《Weak Supervision for Fake News Detection via Reinforcement Learning》 |文本审核&质量 |
...
| NULL  | 《Data Programming:Creating Large Training Sets, Quickly》 |半监督学习 |
| NULL  | 《Rethinking the Value of Labels for Improving Class-Imbalanced Learning》 |半监督学习 |
| NULL  | 《Extreme Multi-label Loss Functions for Recommendation,Tagging, Ranking & Other Missing Label Applications》 |多标签残缺 |
| NULL  | 《基于不完整标签信息的多标签分类问题研究》 |多标签残缺 |
| NULL  | 《Dice loss for data-imbalance NLP tasks》 |样本不均衡 |
| NULL  | 《Meta-Weight-Net: Learning an Explicit Mapping For Sample Weighting》 |样本不均衡 |
| NULL  | 《ehensive Introduction to Label Noise》 |噪声标签 |
| NULL  | 《Classification in the Presence of Label Noise: a Survey》 |噪声标签 |
| NULL  | 《Image Classification with Deep Learning in the Presence of Noisy Labels: A Survey》 |噪声标签 |
| NULL  | 《Confident Learning: Estimating Uncertainty in Dataset Labels》 |噪声标签 |
| NULL  | 《Co-teaching: Robust Training of Deep Neural Networks with Extremely Noisy Labels》 |噪声标签 |
| NULL  | 《Learning with Noisy Label-深度学习廉价落地》 |噪声标签 |
...
| NULL  | 《Analyzing and Interpreting Neural Networks for NLP: A Report on the First BlackboxNLP Workshop》 |模型可解释性 |
| NULL  | 《NeuralClassifier: An Open-source Neural Hierarchical Multi-label Text Classification Toolkit》 |算法框架&工具 |
| NULL  | 《Familia: A Configurable Topic Modeling Framework for Industrial Text Engineering》 |算法框架&工具 |
| NULL  | 《LightLDA: Big Topic Models on Modest Computer Clusters》 |算法框架&工具 |
| NULL  | 《DeepPavlov: Open-Source Library for Dialogue Systems》 |算法框架&工具 |
| NULL  | 《AllenNLP Interpret: A Framework for Explaining Predictions of NLP Models》 |算法框架&工具 |
...
| NULL  | 《Analysis Methods in Neural Language Processing: A Survey》 |其他 |
| NULL  | 《Deep Double Descent: Where Bigger Models and More Data Hurt》 |其他 |
| NULL  | 《中文信息处理发展报告》 |其他 |
| NULL  | 《Modern Deep Learning Techniques Applied to Natural Language Processing》 |其他 |
| NULL  | NULL |NULL |
| NULL  | NULL |NULL |
| NULL  | NULL |NULL |
| NULL  | NULL |NULL |
