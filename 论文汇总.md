...
| 259  | 《Aggregated Residual Transformations for Deep Neural Networks》 |CNN |
...
| NULL  | 《UNIMO: Towards Unified-Modal Understanding and Generation via Cross-Modal Contrastive Learning》 |多模态 |
| NULL  | 《DeepFace: Closing the Gap to Human-Level Performance in Face Verification》 |人脸识别 |
| NULL  | 《End-to-End Text Recognition with Convolutional Neural Networks》 |OCR |
| NULL  | NULL |NULL |
| NULL  | NULL |NULL |
| NULL  | NULL |NULL |
| NULL  | NULL |NULL |
