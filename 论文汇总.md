...
| NULL |NULL |
| NULL |NULL |
| 《OpenPrompt: An Open-source Framework for Prompt-learning》 |ALM/PromptLearning/PromptEngineering |
| 《Delta Tuning: A Comprehensive Study of Parameter Efficient Methods for Pre-trained Language Models》 |ALM/PromptLearning/PromptEngineering |
...
| 《Learning by Distilling Context》 |通用基础大语言模型 |
| 《LLaMA: Open and Efficient Foundation Language Models》 |通用基础大语言模型 |
| 《LARGE LANGUAGE MODELS ARE HUMAN-LEVEL PROMPT ENGINEERS》 |通用基础大语言模型 |
...
| 《Megatron-LM: Training Multi-Billion Parameter Language Models Using Model Parallelism》 |通用基础大语言模型 |
| 《Scaling Instruction-Finetuned Language Models》 |通用基础大语言模型 |
| 2023-《Training language models to follow instructions with human feedback》 |通用基础大语言模型 |
...
| 2022-《TabTransformer: Tabular Data Modeling Using Contextual Embeddings》 |表格特征融合 |
