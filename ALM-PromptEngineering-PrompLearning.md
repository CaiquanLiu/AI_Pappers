...
| 《OpenPrompt: An Open-source Framework for Prompt-learning》 | arxiv2021 | 清华的OpenPrompt：<br/>1 Prompt Learning的工具包；<br/>2 和OpenDelta是一个团队（OpenPrompt更早），相当于在OpenDelta外面包了一层（OpenPrompt是个较大的框架-PromptLearning，而OpenDelta只聚焦在Delta-Tuning）； | NULL | https://zhuanlan.zhihu.com/p/607206925 |
